...
namespace Infusion
{
    public class HarmonyPatcher
    {
        public static void PatchAllVanillaMethods(Harmony instance)
        {
            ...
            HarmonyMethod postfix = new HarmonyMethod(typeof(Infusion.Patches).GetMethod("NotifyApparelAddedPostfix"));
            instance.Patch(original, null, postfix);
            MethodInfo original2 = AccessTools.PropertyGetter(typeof(CompShield), "EnergyGainPerTick");
            HarmonyMethod postfix2 = new HarmonyMethod(typeof(Infusion.Patches).GetMethod("EnergyGainPerTickPostfix"));
            instance.Patch(original2, null, postfix2);
            MethodInfo original3 = AccessTools.PropertyGetter(typeof(CompShield), "EnergyMax");
            HarmonyMethod postfix3 = new HarmonyMethod(typeof(Infusion.Patches).GetMethod("EnergyMaxGetterPostfix"));
            ...
            HarmonyMethod postfix4 = new HarmonyMethod(typeof(Infusion.Patches).GetMethod("NotifyApparelRemovedPostfix"));
            instance.Patch(original4, null, postfix4);
            MethodInfo original5 = AccessTools.Method(typeof(Gizmo_EnergyShieldStatus), "GizmoOnGUI");
            HarmonyMethod transpiler = new HarmonyMethod(typeof(Infusion.Patches).GetMethod("GizmoOnGUITranspiler"));
